...
# Force development mode to True for local development to handle clock skew issues
FIREBASE_AUTH_DEVELOPMENT_MODE = True  # Allow unverified tokens in development
