  ...
  return (
    <nav className="bg-transparent backdrop-blur-md fixed w-full z-50 transition-all duration-300">
        ...
        <div className="flex justify-between items-center h-16 sm:h-18 md:h-20">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              <span className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-white font-serif tracking-tight">BlogHub</span>
            </Link>
          ...
          <div className="flex items-center md:hidden">
            <button
              onClick={toggleDarkMode}
              className="p-1.5 sm:p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none mr-1 sm:mr-2"
              aria-label="Toggle dark mode"
            >
              {darkMode ? (
            ...
            <button
              onClick={toggleMenu}
              className="p-1.5 sm:p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none"
      ...
      <div className={`md:hidden ${isOpen ? 'block' : 'hidden'}`}>
        <div className="px-3 sm:px-4 pt-3 pb-4 space-y-2 bg-white/95 dark:bg-black/95 backdrop-blur-md shadow-lg rounded-b-lg border-t border-gray-200 dark:border-gray-700">
