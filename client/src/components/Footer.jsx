...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-black shadow-inner transition-colors duration-200">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex justify-center md:justify-start">
            <Link to="/" className="flex items-center">
              <span className="text-xl font-bold text-gray-900 dark:text-white font-serif tracking-tight">BlogHub</span>
            </Link>
          </div>
